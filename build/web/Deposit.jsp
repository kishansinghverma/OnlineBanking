...
<body>
                   ...
                   <c:if test="${param.credit ne null}">
                       <sql:update dataSource="${conn}" var="count">
                            UPDATE bank SET amount ='${amount+(param.credit)}' where id=${user_id};
                       </sql:update>
                       ...
                       <c:set var="output" value="Your Account Has Been Credited: ${param.credit} Rs." />
            ...
            <td class="c2">
                ...
                <div class="wrap">
                    ...
                    <form action="Deposit.jsp" method="post">
                        <input type="text" name="credit" placeholder="Amount To Be Deposited" required pattern="^\d{1,}" title="Provide Valid Amount!" maxlength="9">
                        <hr class="hrl">
